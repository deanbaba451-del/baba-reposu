...
print(render('Takipçi', colors=['white', 'cyan'], align='center'))



Username = input(Fore.MAGENTA + "INSTAGRAM kullanici adini gir :  ")


response = requests.post(
    "https://leofame.com/free-instagram-followers",
    data={'token': '4b718a618d5bdae00ade708833612c4f', 'free_link': Username},
    headers={
...
if "Please Wait 48 hours or submit different instagram account" in response:
