...
text = "RAINBOW COLORS"
live_text(rainbow_text('                This tool is by @qfbaran'))
print("\033[1;94m" + "â" * 82)
blue = "\033[1m\033[34m"
green = "\033[1m\033[32m"
WDEH = render('Baran', colors=['blue', 'green'], align='center')
live_text(WDEH)
print('')                                                               
print("\033[1;94m" + "â" * 82)
...
try:
    ...
    exit()
tok = input(f"{green}Enter Token -{cyan} ") 
os.system('clear')
...
def amir():
    os.system('clear')
    output = (f"{cyan}â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±\n"
f"{cyan} {white} ðð¶ðð: {green}{hits} \n"
f"{white} ð½ðð Ä°ð£ð¨ð©ð: {red}{badinsta} \n"
f"{white} ð½ðð ðððð¡: {yellow}{bademail} \n"
f"{white} ð¾ð ð ð IG: {orange}{goodig} {cyan}\n"
f"{white} DEV: @qfbaran {cyan}"
f"{cyan}â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±â±\n"
              f"\r")
    sys.stdout.write(output)
    sys.stdout.flush()

a = print(f"""                            
{cyan}| -> ð­ . -  ð®ð¬ð­ð® - ð®ð¬ð­ð¯

{cyan}| -> ð®. -   ð®ð¬ð­ð° - ð®ð¬ð­ð±

{cyan}| -> ð¯ - ð®ð¬ð­ð¬ - ð®ð¬ð­ðµ
                                                
""")
Vortex = input(f"{white} Ãabuk Sec Am : {reset}")
...
def InfoAcc(username, gg):
    ...
    aca += 1
    tlg = f'''
ð¥ â¨ ð½ðð§ðð£ ðð£ð¨ð©ððð§ðð¢ ððð© â¨ ð¥
âââââââââââââââââââââââââââââ
ð¯ Hit Count â {aca}  
ð¤ Username â @{username}
ð¬ Email â {username}@{gg}  
ð Reset â {rest(username)}  
ð URL â https://www.instagram.com/{username}
ð¥ Followers â {fows}
â Following â {fowg}
ð¸ Posts â {pp}
âââââââââââââââââââââââââââââ
ð Developer â @qfbaran ð
âââââââââââââââââââââââââââââ
'''

    with open('Baranhits.txt', 'a') as ff:
        ff.write(f'{tlg}\n')

    try:
        try:
            requests.get(f"https://api.telegram.org/bot{tok}/sendMessage?chat_id={ID}&text={tlg}")
        except:
            pass
    except Exception as e:
        pass
