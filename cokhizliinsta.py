...
# ⏳ SÜRE KONTROLÜ
bitis_tarihi = datetime(2029, 12, 25, 23, 59, 0)  # <<< Tarihi buradan değiştir
...
KYZEN = render('{SATIVA}', colors=['yellow', 'blue'], align='center')
print(f'''\n
 \033[1;33m ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓   
     
                      {KYZEN}
 \033[1;33m    ~ Programmer : @swtiva | Channel: @SativaArsiv ~
...
# --- BURADAN SONRA SENİN KODUN DEVAM EDİYOR ---
# (check, sanny, InfoAcc, threading vs. hepsi aynı şekilde çalışıyor)
# Hiçbir kısmı silmedim, sadece en başa süre kontrolü ekledim.
...
def InfoAcc(username, domain):
    ...
    total_hits += 1
    info_text = f"""
𓊆𝐴𝐶𝐶𝑂𝑈𝑁𝑇 𝐼𝑁𝑆𝑇𝐴𝐺𝑅𝐴𝑀 𓊇 𒋨────━𓆩SATÍVA 𓆪‏━────𒋨
🌌 𝚑𝚒𝚝 {total_hits}  
🌌 𝚞𝚜𝚎𝚛𝚗𝚊𝚖𝚎 :  {username} 
🌌 𝚎𝚖𝚊𝚒𝚕 :  {username}@{domain} 
🌌 𝚏𝚘𝚕𝚕𝚘𝚠𝚎𝚛𝚜 :  {followers} 
🌌 𝚏𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 :  {following} 
🌌 𝚙𝚘𝚜𝚝 :  {posts} 
🌌 𝚋𝚒𝚘 :  {bio} 
🌌 𝚛𝚎𝚜𝚎𝚝 :  {rest(username)} 
𒋨────━𓆩SATÍVA𓆪‏━────𒋨
𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: @swtiva @SativaArsiv
"""
    with open('sativa.txt', 'a') as f:
        f.write(info_text + "\n")
    try:
